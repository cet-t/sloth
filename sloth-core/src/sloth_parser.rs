//! Skeleton bridge: sloth-parser (TOML/JSON) -> sloth_core::Layout.
//!
//! NOTE: This is intentionally a skeleton. The following are wired:
//!   - base (or `states.default`) layer -> `single_map`
//!   - `combos` (同時押し)            -> `combos`
//!   - `sequences` (順押し, len>=2)   -> `prefix_maps`
//!
//! TODO (not yet modeled):
//!   - named layers (shift/kana) and `states`-driven layer switching
//!   - `combo_keys` / `prefix_triggers` / `sustained_triggers` bookkeeping
//!   - `mode` derivation (Legacy/Sequential/Simultaneous/Mixed)

use std::collections::{HashMap, HashSet};

use sloth_parser::{
    CompiledLayer, CompiledLayout, KeyboardLayout as PKeyboard, Key as PKey, OutputSeq as PSeq,
    OutputToken as PTok,
};
...
impl LayoutLoader for SlothLayoutLoader {
    ...
    fn load(&self, bytes: &[u8], id: &str) -> Result<Layout, LoadError> {
        let text =
            std::str::from_utf8(bytes).map_err(|e| LoadError::Parse(e.to_string()))?;
...
fn to_core_key(k: PKey) -> KeyCode {
    use KeyCode as C;
    match k {
        PKey::A => C::A, PKey::B => C::B, PKey::C => C::C, PKey::D => C::D, PKey::E => C::E,
        PKey::F => C::F, PKey::G => C::G, PKey::H => C::H, PKey::I => C::I, PKey::J => C::J,
        PKey::K => C::K, PKey::L => C::L, PKey::M => C::M, PKey::N => C::N, PKey::O => C::O,
        PKey::P => C::P, PKey::Q => C::Q, PKey::R => C::R, PKey::S => C::S, PKey::T => C::T,
        PKey::U => C::U, PKey::V => C::V, PKey::W => C::W, PKey::X => C::X, PKey::Y => C::Y,
        PKey::Z => C::Z,
        PKey::Num0 => C::Num0, PKey::Num1 => C::Num1, PKey::Num2 => C::Num2, PKey::Num3 => C::Num3,
        PKey::Num4 => C::Num4, PKey::Num5 => C::Num5, PKey::Num6 => C::Num6, PKey::Num7 => C::Num7,
        PKey::Num8 => C::Num8, PKey::Num9 => C::Num9,
        PKey::Minus => C::Minus, PKey::Equal => C::Equal, PKey::LBracket => C::LBracket,
        PKey::RBracket => C::RBracket, PKey::Backslash => C::Backslash, PKey::Semicolon => C::Semicolon,
        PKey::Quote => C::Quote, PKey::Comma => C::Comma, PKey::Dot => C::Dot, PKey::Slash => C::Slash,
        PKey::Grave => C::Grave,
        PKey::ShiftL => C::ShiftL, PKey::ShiftR => C::ShiftR, PKey::CtrlL => C::CtrlL,
        PKey::CtrlR => C::CtrlR, PKey::AltL => C::AltL, PKey::AltR => C::AltR,
        PKey::MetaL => C::MetaL, PKey::MetaR => C::MetaR,
        PKey::Space => C::Space, PKey::Enter => C::Enter, PKey::Tab => C::Tab,
        PKey::Backspace => C::Backspace, PKey::Escape => C::Escape, PKey::CapsLock => C::CapsLock,
        PKey::Left => C::Left, PKey::Right => C::Right, PKey::Up => C::Up, PKey::Down => C::Down,
        PKey::F1 => C::F1, PKey::F2 => C::F2, PKey::F3 => C::F3, PKey::F4 => C::F4,
        PKey::F5 => C::F5, PKey::F6 => C::F6, PKey::F7 => C::F7, PKey::F8 => C::F8,
        PKey::F9 => C::F9, PKey::F10 => C::F10, PKey::F11 => C::F11, PKey::F12 => C::F12,
        PKey::Muhenkan => C::Muhenkan, PKey::Henkan => C::Henkan,
        PKey::KanaKatakana => C::KanaKatakana, PKey::HankakuZenkaku => C::HankakuZenkaku,
        PKey::Yen => C::Yen, PKey::Caret => C::Caret, PKey::Colon => C::Colon, PKey::AtSign => C::AtSign,
...
fn to_core_layout(l: CompiledLayout, id: &str) -> Layout {
    let default_name = l
        .states
        .get("default")
        .cloned()
    ...
    let combos: HashMap<Vec<KeyCode>, OutputSeq> = l
        ...
        .iter()
        .map(|(chord, out)| {
            let mut v: Vec<KeyCode> = chord.as_slice().iter().map(|k| to_core_key(*k)).collect();
            canon_sort(&mut v);
            (v, to_core_seq(out.clone()))
        })
        .collect();

    // 順押し: represent a len>=2 sequence as trigger=(prefix) -> content=last.
    // TODO: full multi-branch prefix tries.
    ...
    Layout {
        id: id.to_string(),
        name: l.name,
        mode: crate::layout::LayoutMode::Mixed, // TODO: derive from combos/sequences presence
        ...
        single_map,
        layer_maps: HashMap::new(), // TODO: named layers (shift/kana) + states wiring
        layer_taps: HashMap::new(),
        layer_triggers: HashSet::new(),
        combos,
        combo_keys: HashSet::new(), // TODO: union of combo participant keys
        sustained_triggers: HashSet::new(),
        prefix_maps,
        prefix_triggers: HashSet::new(), // TODO: prefix trigger keys
        simultaneous: vec![],
    }
}
